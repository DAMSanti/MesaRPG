...
WEAPONS_DIR = r"D:\Portfolio\mesa\MesaRPG\modelsmw5\activos\Archer\Model\Weapons"

bpy.ops.wm.open_mainfile(filepath=IN_PATH)

NAME_TO_MATERIAL = {
    "Variant": "Archer_Variant",
    "Body": "Archer_Variant",
    "Weapons": "Archer_Weapons",
    "MissileHead": "Archer_Weapons",
}
variant_mat = bpy.data.materials["Archer_Variant"]
weapons_mat = bpy.data.materials["Archer_Weapons"]
...
for o in list(bpy.data.objects):
    ...
    for i, name in enumerate(slot_names):
        ...
        if mat_name is None:
            ...
            continue
        mesh_obj.data.materials[i] = variant_mat if mat_name == "Archer_Variant" else weapons_mat
    fixed += 1
