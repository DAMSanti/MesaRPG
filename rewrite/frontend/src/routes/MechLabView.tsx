 ...
 * already was. */
function filterLongEdgeTriangles(geometry: THREE.BufferGeometry): THREE.BufferGeometry {
...
function bakeSkinnedGeometry(mesh: THREE.SkinnedMesh, geometry: THREE.BufferGeometry): THREE.BufferGeometry {
 ...
 * it out. */
function recenterBakedPiece(visualGeometry: THREE.BufferGeometry, matrixWorld: THREE.Matrix4): BakedPiece {
...
function buildBakedPiece(mesh: THREE.SkinnedMesh, geometry: THREE.BufferGeometry): BakedPiece {
